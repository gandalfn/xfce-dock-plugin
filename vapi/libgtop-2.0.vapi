...
namespace GLibTop {
    ...
    [CCode (cheader_filename = "glibtop.h", cname = "glibtop_get_proc_argv", array_null_terminated = true)]
    public static string[] get_proc_argv (out proc_args buf, GLib.Pid pid, uint max_len);
    ...
    [CCode (cheader_filename = "glibtop/procargs.h", destroy_function = "")]
    public struct proc_args {
        public uint64 flags;
        public uint64 size;
    }
}
